...
```{r}
# plotting function
DimPlot2 <- function(object = "seur", assay = "SCT", features, title, ...) {
  p <- DotPlot(seur, 
               assay = "SCT",
               features = features, 
...
for(i in names(markers)) {
  ...
  top50marker.plots[[i]] <- DimPlot2(features = features, title = i)
...
### Cluster 0 and related clusters
