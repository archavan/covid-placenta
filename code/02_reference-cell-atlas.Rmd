...
vento.raw <- readSparseCounts("../info/from-papers/vento-tormo_2018/10x_arrayexpress/raw_data_10x.txt", sep = "\t", row.names = TRUE, col.names = TRUE, chunk = 100)  # have to use readSparseCounts because the file is too big. 
```
